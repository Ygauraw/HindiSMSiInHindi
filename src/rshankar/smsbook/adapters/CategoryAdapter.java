...
public class CategoryAdapter extends BaseAdapter{
	...
	private int categoryIcons[] = new int[] {
			...
			R.drawable.ic_group,
			R.drawable.ic_rose_day,
			R.drawable.ic_prapose_day,
			R.drawable.ic_chocklate_day,
			R.drawable.ic_taddy_day,
			R.drawable.ic_engagement,
			R.drawable.ic_hug_day,
			R.drawable.ic_kiss_day,
			R.drawable.ic_valintine_day,
			R.drawable.ic_group,
